...
const translations = {
  en: {
    ...
    'msg.cash_usd': 'Cash (USD)',
    'msg.cash_uzs': 'Cash (UZS)',
    'msg.cash_eur': 'Cash (EUR)',
    'msg.online_charged_label': 'Online Charged (not physical cash)',
    'msg.online_usd': 'Online (USD)',
    'msg.online_uzs': 'Online (UZS)',
    'msg.online_eur': 'Online (EUR)',
    'exchange.title': 'Currency Exchange',
    'exchange.from_currency': 'From Currency',
    'exchange.amount': 'Amount',
    'exchange.rate': 'Exchange Rate',
    'exchange.get_current_rate': 'Get Current Rate',
    'exchange.to_uzs': 'To UZS',
    'exchange.result': 'Resulting UZS',
    'exchange.confirm': 'Confirm Exchange',
    'exchange.cancel': 'Cancel',
    'exchange.rate_fetch_error': 'Could not fetch rate, please enter manually',
    'exchange.success': 'Exchange recorded successfully',
    'exchange.insufficient_balance': 'Cash box only has {amount} {currency} available',
    ...
    'admin.force_logout_confirm': 'This will sign {name} out of all their devices — continue?',
    'admin.password_reset_success': 'Password reset successfully',
    'admin.force_logout_success': 'User logged out successfully',
    ...
    // Manager Booking Modal
    'manager_booking.title': 'New Manager Booking',
    'manager_booking.international': 'International',
    'manager_booking.local': 'Local',
    'manager_booking.pool': 'Pool',
    'manager_booking.camper_toggle': 'Guest is a Camper',
    'manager_booking.camper_subtitle': "Registers as 'camper' category",
    'manager_booking.day_visit': '☀️ Day Visit',
    'manager_booking.night_stay': '🌙 Night Stay',
    'manager_booking.guest_name': 'Guest Name',
    'manager_booking.guest_name_placeholder': 'Full Name...',
    'manager_booking.adults': 'Adults',
    'manager_booking.children': 'Children (under 12)',
    'manager_booking.checkout': 'Check-out',
    'manager_booking.payment_method': 'Payment Method',
    'manager_booking.cash': 'Cash',
    'manager_booking.online': 'Online',
    'manager_booking.payment_amount': 'Payment Amount (UZS)',
    'manager_booking.currency_suffix': 'SUM',
    'manager_booking.amount_placeholder': '0.00',
    'manager_booking.processing': 'Processing...',
    'manager_booking.pay_register': 'PAY & REGISTER',
    'manager_booking.create_booking': 'CREATE BOOKING',
    ...
    'txn.category_workers_income': 'Worker Payment',
    'txn.category_gas': 'Gas for Car',
    'txn.category_other_expenses': 'Other Expenses',
    'txn.period_start_label': 'Paid from',
    'txn.period_end_label': 'Paid to',
    'txn.worker_payments_section': 'Worker Payments',
    'txn.worker_name_label': 'Worker Name',
    'txn.add_new_worker': '+ Add new worker',
    'txn.tab_drinks': 'Drinks',
    'txn.date_format_month_short': 'M',
    'txn.view_all_workers': 'View all workers',
    'txn.all_workers': 'All Workers',
    'txn.total_paid': 'Total Paid',
  ...
  uz: {
    ...
    'form.select_worker': 'Ishchini tanlang',
    ...
    'msg.cash_usd': 'Naqd (USD)',
    'msg.cash_uzs': 'Naqd (UZS)',
    'msg.cash_eur': 'Naqd (EUR)',
    'msg.online_charged_label': 'Onlayn toʻlov (naqd emas)',
    'msg.online_usd': 'Onlayn (USD)',
    'msg.online_uzs': 'Onlayn (UZS)',
    'msg.online_eur': 'Onlayn (EUR)',
    'exchange.title': 'Valyuta almashinuvi',
    'exchange.from_currency': 'Qaysi valyutadan',
    'exchange.amount': 'Miqdor',
    'exchange.rate': 'Almashinuv kursi',
    'exchange.get_current_rate': 'Joriy kursni olish',
    'exchange.to_uzs': 'UZS ga',
    'exchange.result': 'Natija (UZS)',
    'exchange.confirm': 'Tasdiqlash',
    'exchange.cancel': 'Bekor qilish',
    'exchange.rate_fetch_error': 'Kursni olish imkonsiz, qoʻlda kiriting',
    'exchange.success': 'Almashinuv muvaffaqiyatli qayd etildi',
    'exchange.insufficient_balance': 'Kassa qutisi faqat {amount} {currency} ga ega',
    'admin.reset_password': 'Parolni tiklash',
    'admin.force_logout': 'Chiqarish',
    'admin.new_password': 'Yangi parol',
    'admin.confirm_password': 'Parolni tasdiqlash',
    'admin.last_login': 'Oxirgi kirish',
    'admin.force_logout_confirm': 'Bu {name} ni barcha qurilmalaridan chiqaradi — davom etasizmi?',
    'admin.password_reset_success': 'Parol muvaffaqiyatli tiklandi',
    'admin.force_logout_success': 'Foydalanuvchi muvaffaqiyatli chiqarildi',
    ...
    // Manager Booking Modal
    'manager_booking.title': 'Yangi Menejer Band qilishi',
    'manager_booking.international': 'Xalqaro',
    'manager_booking.local': 'Mahalliy',
    'manager_booking.pool': 'Hovuz',
    'manager_booking.camper_toggle': 'Mehmon lagernikidir',
    'manager_booking.camper_subtitle': "'Camper' toifasida roʻyxatga olinadi",
    'manager_booking.day_visit': '☀️ Kunlik tashrif',
    'manager_booking.night_stay': '🌙 Kechalab qolish',
    'manager_booking.guest_name': 'Mehmon ismi',
    'manager_booking.guest_name_placeholder': 'Toʻliq ism...',
    'manager_booking.adults': 'Kattalar',
    'manager_booking.children': 'Bolalar (12 yoshgacha)',
    'manager_booking.checkout': 'Ketish sanasi',
    'manager_booking.payment_method': 'Toʻlov usuli',
    'manager_booking.cash': 'Naqd',
    'manager_booking.online': 'Onlayn',
    'manager_booking.payment_amount': 'Toʻlov miqdori (UZS)',
    'manager_booking.currency_suffix': 'SOʻM',
    'manager_booking.amount_placeholder': '0.00',
    'manager_booking.processing': 'Qayta ishlanmoqda...',
    'manager_booking.pay_register': 'TOʻLOV VA ROʻYXATGA OLISH',
    'manager_booking.create_booking': 'BAND QILISH YARATISH',
    ...
    'txn.period_start_label': 'Toʻlangan sana (dan)',
    'txn.period_end_label': 'Toʻlangan sana (gacha)',
    'txn.worker_payments_section': 'Ishchilarga toʻlovlar',
