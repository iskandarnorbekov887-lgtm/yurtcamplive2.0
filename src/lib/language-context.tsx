...
const translations = {
  en: {
    ...
    'login.subtitle': 'Next-Gen Yurt Management',
  ...
  uz: {
    ...
    'login.subtitle': 'Yurtlarni boshqarishning yangi avlodi',
    ...
    'form.yurt_select': 'Yurtni tanlang',
    'form.source': 'Manba',
