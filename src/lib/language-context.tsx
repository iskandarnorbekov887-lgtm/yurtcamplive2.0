...
const translations = {
  en: {
    ...
    'form.yurt_select': 'Select Isky Camp',
    'form.source': 'Source',
    ...
    'manager.yurt_overview': 'Isky Camp Status Overview',
  ...
  uz: {
    ...
    'form.yurt_select': 'Isky Campni tanlang',
    'form.source': 'Manba',
    ...
    'manager.yurt_overview': 'Isky Camplar holati',
