  ...
  const fetchSettings = useCallback(async () => {
    ...
    try {
      ...
      if (data) {
        ...
        // Private key lives in Vault now — never fetched into the browser.
        setHasExistingKey(Boolean((data as any).google_private_key_secret_id));
        setPrivateKey('');
            ...
            {integrationMethod === 'api' ? (
              <>
                ...
                <div className="space-y-2">
                  ...
                  {hasExistingKey && (
                    <p className="text-[10px] text-[#9C9384] px-1">
